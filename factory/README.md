Factory pattern is one of the most used design pattern. It is a creational pattern and it is frequently used to decouple creation of an object from business implementation of the system. 
